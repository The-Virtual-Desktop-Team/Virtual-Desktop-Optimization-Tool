Function _OptimizeDiskCleanup {
    ...
    Process {
        If ($Optimizations -contains "DiskCleanup" -or $Optimizations -contains "All") {
            ...
            Write-Host "Removing .tmp, .etl, .evtx, thumbcache*.db, *.log files not in use" -ForegroundColor Cyan
            ...
            Write-Host "Removing Retail Demo content (if it exists)" -ForegroundColor Cyan
            ...
            Write-Host "Removing all files not in use in $env:windir\TEMP" -ForegroundColor Cyan
            ...
            Write-Host "Cleaning up WER report archive" -ForegroundColor Cyan
            ...
            Write-Host "Removing files not in use in $env:temp directory" -ForegroundColor Cyan
            ...
            Write-Host "Clearing out ALL Recycle Bins" -ForegroundColor Cyan
            ...
            Write-Host "Clearing BranchCache cache" -ForegroundColor Cyan
